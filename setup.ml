...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75842637542668986bd8290567e07ed2) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("faraday", None)];
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Bigstring"; "Message"];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "]\225\127vm\178|\224B\139/\022\223\162\249\187";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
